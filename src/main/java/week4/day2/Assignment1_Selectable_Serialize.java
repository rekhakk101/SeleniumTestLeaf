...
public class Assignment1_Selectable_Serialize {
	...
	public static void main(String[] args) {
		...
		WebElement selected = driver
				.findElement(By.xpath("//span[text()=\"You've selected:\"]/following-sibling::span"));
		String text = selected.getText();
		System.out.println("Selected items are: " + text);

		String attribute = item3.getAttribute("class");
